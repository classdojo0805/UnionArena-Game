...
# ================= 配置區 =================
INPUT_FILE = r"C:\Users\user\Documents\UA_APP0.1\Log_jason\TKG_final_structured.json"
DISPLAY_FILE = r"C:\Users\user\Documents\UA_APP0.1\Log_jason\TKG_final_Cards_Display.json"
LOGIC_FILE = r"C:\Users\user\Documents\UA_APP0.1\Log_jason\TKG_final_Cards_Logic_1.json"
        ...
        for attempt in range(max_retries):
            try:
                ...
                response = client.models.generate_content(
                    ...
                    contents=f"請將以下卡牌效果轉換為符合規則的 JSON：\n{text}",
...
def run_split():
    ...
    for idx, card in enumerate(raw_list[41:82]): # 測試階段維持 0:10
